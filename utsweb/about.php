...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbars">
    <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
      ...
      <li class="active"><a class="nav-link" href="about.php">Tentang Saya</a></li>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-5">
          <div class="intro-excerpt">
            ...
            $data = 'SELECT judul, deskripsi FROM TentangSaya'; 
            ...
            ?>
            <p><a href="activity.php" class="btn btn-secondary me-2">Kegiatan Saya</a></p>
          </div>
        </div>
        <div class="col-lg-6">
